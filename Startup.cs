...
namespace AnuncioWebMotors
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AnuncioWebMotorsContext>(options =>
                    options.UseMySql(Configuration.GetConnectionString("WebMotorsConection"), 
                    builder => builder.MigrationsAssembly("AnuncioWebMotors")));

            services.AddScoped<AnuncioWebMotorsContext>();
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            {
                app.UseExceptionHandler("/Anuncio/Error");
                app.UseHsts();
            }
